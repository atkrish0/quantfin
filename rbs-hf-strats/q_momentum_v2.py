...
Original file is located at
    https://colab.research.google.com/drive/1Kqnm7kxxkVYs64XXh_AQ-uH9-bqcf3bD
"""
...
def portafolio_ret(date):
    portafolio = data.loc[date:, get_top(date)][1:2]  # Use top stocks
    return portafolio.mean(axis=1).values[0]
...
for i in range(1, len(data) - 1):
    data['returns'][i] = portafolio_ret(data.index[i])
